...
int main()
{
	...
	int value = 0; //переменные размера списка и вводимых данных
	int flag = 1, c;
	int list_size;
	...
	cout << "Задание №1 - Унарные операции (класс целых чисел)\n";

	Integer Int;
	cout << "Введите целое число, с которым хотите работать: " << endl;
	cin >> value;
	Int.setData(value);
	system("cls");
	...
	while (flag == 1)
	{
		...
		cout << "1 - Ввести новое целое число" << endl;
